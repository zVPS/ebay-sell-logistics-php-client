...
class Rate implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        ...
        'pickup_slots' => '\Ebay\Sell\Logistics\Model\PickupSlot[]',
        'pickup_type' => 'string',
        'rate_id' => 'string',
     ...
     * Gets pickup_slots
     *
     * @return \Ebay\Sell\Logistics\Model\PickupSlot[]|null
     */
     ...
     * Sets pickup_slots
     *
     * @param \Ebay\Sell\Logistics\Model\PickupSlot[]|null $pickup_slots A list of available pickup slots for the package.
     *
     * @return self
     */
     ...
     * Sets pickup_type
     *
     * @param string|null $pickup_type The type of pickup or drop-off service associated with the pickupSlots time frames. For implementation help, refer to <a href='https://developer.ebay.com/api-docs/sell/logistics/types/api:PickupTypeEnum'>eBay API documentation</a>
     *
     * @return self
     */
     ...
     *
     * @param string|null $shipping_carrier_code The code name of the shipping carrier who will provide the service identified by shippingServiceCode.
     *
     * @return self
     */
     ...
     *
     * @param string|null $shipping_service_code The code name of the shipping service to be provided by the carrier identified by shippingCarrierCode.
     *
     * @return self
     */
